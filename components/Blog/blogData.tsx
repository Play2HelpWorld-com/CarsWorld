...
const BlogData: Charity[] = [
  {
    ...
    title: "Cars World World Water Aid",
    metadata:
      "Cars World, an innovative platform where gaming meets social impact. Designed to bring entertainment and purpose together, Cars World allows users to play exciting games, earn coins, and contribute to meaningful social causes.",
  },
  {
    ...
    title: "Cars World World WWF",
    metadata:
      "Cars World offers a wide variety of games that cater to all interests and skill levels. Players can immerse themselves in thrilling adventures, puzzles, strategy games, and more. As you play and achieve milestones, you earn coins that can be used",
  },
  {
    ...
    title: "Cars World World MSF Doctors Without Borders",
    metadata: "Cars World offers a wide variety of games that cater to all interests and skill levels. Players can immerse themselves in thrilling adventures, puzzles, strategy games, and more. As you play and achieve milestones, you earn coins that can be used",
  },
  {
  ...
  },
  {
    ...
    title: "Cars World Cancer Research",
    metadata: "Cars World offers a wide variety of games that cater to all interests and skill levels. Players can immerse themselves in thrilling adventures, puzzles, strategy games, and more. As you play and achieve milestones, you earn coins that can be used",
  },
  {
  ...
  },
  {
    ...
    title: "Cars World Alzheimer's Society",
    metadata: "Cars World offers a wide variety of games that cater to all interests and skill levels. Players can immerse themselves in thrilling adventures, puzzles, strategy games, and more. As you play and achieve milestones, you earn coins that can be used",
  },
  {
